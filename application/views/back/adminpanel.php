        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url();?>register-form"><i class="fa fa-user-plus fa-fw"></i>Daftar Pengguna</a>
                    </li>
                    <li>
                      ...
                      <li>
                        <a href="#"><i class="fa fa-product-hunt fa-fw"></i> Pilih Barang<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                 <a href="<?php echo base_url();?>add-product"><i class=""></i>Tambah Barang</a>
                             </li>
                            <li>
                                 <a href="<?php echo base_url();?>product-list"><i class=""></i>Daftar Barang</a>
                            </li>
                        </ul>
                    </li>

                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Pilih Merk<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo base_url();?>add-brand">Tambah Merk</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>brand-list">Daftar Merk</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                     <li>
                        <a href="<?php echo base_url()?>manage-order"><i class="fa fa-flask fa-fw"></i>Kelola Pesanan</a>
                    </li>
                </ul>
                <!-- end side-menu -->
            </div>
