        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?php  echo base_url();?>delete-contact/<?php echo $contact_message_by_id->contact_id;?>" type="button" class="btn btn-primary">Hapus Pesan</a>
