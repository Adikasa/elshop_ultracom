...
<h4>Terima kasih atas pembelian Anda dari situs web Ultracom.</h4><hr/>
	...
	<section id="do_action">
		<div class="container">
			<h2 class="text-center">Berikut adalah rincian pesanan Anda.....</h2>
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="total_area">
						<ul>
							...
							?>
							<li>PPN 12% <span>$<?php echo $tax?></span></li>
							...
							?>
							<li>Biaya Pengiriman <span>$<?php echo $shiping?></span></li>
