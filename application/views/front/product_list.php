		...
		<div class="product-image-wrapper">
			<div class="single-products">
				<div class="productinfo text-center">
					...
					<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Tambahkan Keranjang</a>
				</div>
				<div class="product-overlay">
					...
					<form action="<?php echo base_url()?>add-to-cart"  method="post">
							...
							<a href="<?php echo base_url()?>product-details/<?php echo $value->pro_id?>" class="btn btn-default add-to-cart"><i class="fa fa-info"></i>Detail</a>
						</form>	
					</div>
				</div>
			</div>
